...
\leftheader{%
  {\LARGE\bfseries\sffamily Мотивационное письмо}


 
  \makefield{\faIcon{address-card}}{\href{mailto:example@gmail.com}{\texttt{Вологин Вадим}}}
  \makefield{\faTelegram}{\texttt{$@K\_ufzu\_K$}}

  %\makefield{\faLinkedin}
  %{\href{http://www.linkedin.com/in/example/}{\texttt{example}}}

  %% Next line
  \makefield{\faGlobe}{\url{vologin.vv@phystech.edu}}
